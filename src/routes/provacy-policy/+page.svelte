...
<svelte:head>
	<title>Rajeev K Rao - Privacy policy</title>
</svelte:head>
	...
	<main>
		...
		<ul>
			...
			<li>
				<p>
					...
					or &quot;Our&quot; in this Agreement) refers to Rajeev K Rao.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					<strong>Website</strong> refers to Rajeev K Rao, accessible from
					<a href="portfolio.rkrao.me" rel="external nofollow noopener" target="_blank">portfolio.rkrao.me</a>
				</p>
			</li>
			<li>
				<p>
		...
		<p>
			...
			are deleted as soon as You close Your web browser. You can learn more about cookies here: <a
				...
				target="_blank">Cookies by TermsFeed Generator</a
			>.
		</p>
